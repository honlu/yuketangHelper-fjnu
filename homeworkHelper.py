...
# 登录上研究生雨课堂，然后按F12-->选Application-->找到它的cookies，寻找csrftoken和sessionid字段，并复制到下面两行即可
...
def do_homework(submit_url, classroom_id, course_sign, course_name):
    ...
    for homework in homework_ids:
        get_leaf_type_id_url = "https://yjsy-fjnu.yuketang.cn/mooc-api/v1/lms/learn/leaf_info/"+str(classroom_id)+"/"+str(homework)+"/?term=latest&uv_id=3323"
        ...
        try:
            ...
            continue
        problem_url = "https://yjsy-fjnu.yuketang.cn/mooc-api/v1/lms/exercise/get_exercise_list/"+str(leaf_id)+"/?term=latest&uv_id=3323"
